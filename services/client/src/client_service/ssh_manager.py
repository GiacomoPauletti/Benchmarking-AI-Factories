...
class SSHManager:
    ...
    Singleton class that provides functionality for:
    ...
    def __new__(cls, ssh_host: Optional[str] = None, ssh_user: Optional[str] = None, ssh_port: Optional[int] = None, ssh_key_path: Optional[str] = None):
        """Create or return the singleton instance."""
        if cls._instance is None:
            cls._instance = super(SSHManager, cls).__new__(cls)
        return cls._instance
    
    def __init__(self, ssh_host: Optional[str] = None, ssh_user: Optional[str] = None, ssh_port: Optional[int] = None, ssh_key_path: Optional[str] = None):
    ...
    def setup_slurm_rest_tunnel(self, local_port: int = 6820, 
        ...
        try:
            ...
            self.logger.error("SSH tunnel creation timed out. Raising error.")
            raise RuntimeError("SSH tunnel creation timed out")
        except Exception as e:
            self.logger.error(f"Failed to establish SSH tunnel: {e}. Raising error.")
